...
#* Author: Meher Khan
#* 
#* Purpose: A function that will generate a random sample of normal observations
...
#*  
#* Outputs: A plot of the histogram is provided!
#*          A list with the following elements:
#*          Random_values = a vector with the generated random values
#*          Mean_Random_values = the corresponding sample mean
#*          SD_Random_values = the corresponding standard deviation
#* 
